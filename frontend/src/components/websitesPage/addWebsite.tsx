        ...
        h-fit w-150 ring-1 ring-neutral-600 rounded-md p-10`}>
            ...
            <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                    <span className={inputTitle}>Enter page name</span>
                ...
                <div className="flex flex-col gap-1">
                    <span className={inputTitle}>Enter page URL</span>
                    {formData.url !== '' &&
            ...
            <div className='w-full flex justify-between'>
                <button onClick={() => addWebsite()}
                    className="cursor-pointer bg-black p-3 min-w-30 rounded-xs text-[16px] text-gray-400 hover:text-white">Add website</button>
